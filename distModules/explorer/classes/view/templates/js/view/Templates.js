  ...
  "<ul class='clearfix'>"+
    "<% if(defaultOption){ %> "+
      "<li data-term-id='<%- defaultOption.value %>' > "+
        ...
        "<img class='icon' src='"+cogumelo.publicConf.mediaHost+"cgmlImg/<%- icon %>-a<%- iconAKey %>/typeIcon/icon.png'>" +
        "<img class='iconHover' src='"+cogumelo.publicConf.mediaHost+"cgmlImg/<%- icon %>-a<%- iconAKey %>/typeIconHover/iconHover.png'>" +
        "<img class='iconSelected' src='"+cogumelo.publicConf.mediaHost+"cgmlImg/<%- icon %>-a<%- iconAKey %>/typeIconSelected/iconSelected.png'>" +
      "</li>"+
    "<%}%>"+
    "<%= options %>"+
  "</ul>";
